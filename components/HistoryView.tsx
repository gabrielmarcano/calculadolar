        ...
        <div className="flex flex-col h-full bg-[#0a0a0a] text-white">
            ...
            <div className="flex-none flex items-center justify-between p-4">
                <button
                    ...
                    className="w-12 h-12 flex items-center justify-center rounded-full bg-[#2d2d2d] hover:bg-[#3d3d3d] text-gray-300 transition-transform duration-75 ease-out active:scale-95 cursor-pointer"
                    aria-label="Volver"
                >
                ...
                {rateKeys.map(key => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-transform duration-75 ease-out active:scale-95 cursor-pointer whitespace-nowrap ${
                                isActive
                        ...
                        >
                            {rate.imageUrl && (
                                <Image src={rate.imageUrl} alt={rate.displayName} width={48} height={48} className="w-5 h-5 rounded-full object-contain shrink-0" unoptimized priority />
                            )}
                            {rate.displayName}
                        </button>
                    );
            ...
            <div className="flex-none flex gap-1 px-4 pb-4">
                {RANGES.map(r => (
                    <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-xs font-bold transition-transform duration-75 ease-out active:scale-95 cursor-pointer ${
