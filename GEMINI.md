...
- [mobile-first-ergonomics.md](file:///Users/gabriel/Code/personal/calculadolar/.agents/rules/mobile-first-ergonomics.md): Diseño y ergonomía 100% móvil (Thumb Zone, 48px hit targets, Safe Areas `dvh`, `tabular-nums`, microinteracciones y hápticos). Prohibido desktop.
